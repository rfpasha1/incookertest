...
const MyDb = class {
    ...
    async dbClose() {
        ...
        try {
            ...
            console.log('База Данных демонтирована и закрыта');
        } catch (error) {
            console.log(error);
        }
    };
    ...
    //Метод записывает коллекцию
    async saveFullCollection(data) {
    ...
    //Метод удаляет все документы из БД 
    async deleteAllDocuments() {
        ...
        try {
            ...
            console.log(`Все документы из коллекции ${this.collection} удалены`);
        }
    };
}
